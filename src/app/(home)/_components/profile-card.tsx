...
const ProfileCard = () => {
  return (
    <div className="flex flex-col p-10 gap-24 bg-muted hover:bg-muted-foreground transition-all duration-150 ease-[cubic-bezier(0.22, 1, 0.36, 1)] rounded-xl font-light cursor-pointer relative group flex-1">
